function getWorkbenchCustomizations(
  ...
  return {
    ...
    "activityBar.foreground": getColor("accent", 11),
    "activityBar.inactiveForeground": getColor("neutral", getTypeShade(6)),
    "activityBarBadge.background": getColor("accent", 11, 0.5),
    "activityBarBadge.foreground": getColor("neutral", 16),
    "badge.background": getColor("accent", 11, 0.5),
    ...
    "button.background": getColor("accent", 8),
    "button.foreground": getColor("neutral", 16),
    "button.hoverBackground": getColor("accent", 9),
    ...
    "notificationLink.foreground": getColor("accent", 12),
    ...
    "tab.activeBorder": getColor("accent", 11),
    "tab.activeForeground": getColor("neutral", getTypeShade(14)),
    "tab.activeModifiedBorder": getColor("accent", 11, 0.5),
    ...
    "tab.inactiveModifiedBorder": getColor("accent", 11, 0.5),
    "tab.unfocusedActiveForeground": getColor("neutral", getTypeShade(14)),
    "tab.unfocusedActiveModifiedBorder": getColor("accent", 11, 0.5),
    "tab.unfocusedInactiveForeground": getColor("neutral", getTypeShade(10)),
    "tab.unfocusedInactiveModifiedBorder": getColor("accent", 11, 0.5),
    ...
    "textLink.activeForeground": getColor("accent", 12),
    "textLink.foreground": getColor("accent", 12),
