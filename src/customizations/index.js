function getWorkbenchCustomizations(
  ...
  return {
    ...
    "activityBarBadge.background": getColor("accent", getTypeShade(11), 0.5),
    "activityBarBadge.foreground": getColor("neutral", 16),
    "badge.background": getColor("accent", getTypeShade(11), 0.5),
    ...
    "tab.activeModifiedBorder": getColor("accent", getTypeShade(11), 0.5),
    ...
    "tab.inactiveModifiedBorder": getColor("accent", getTypeShade(11), 0.5),
