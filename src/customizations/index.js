function getWorkbenchCustomizations(
  ...
  return {
    ...
    "activityBar.foreground": getColor("accent", 12),
    "activityBar.inactiveForeground": getColor("neutral", getTypeShade(6)),
    "activityBarBadge.background": getColor("accent", 7),
    "activityBarBadge.foreground": getColor("neutral", 16),
    "badge.background": getColor("accent", 7),
    ...
    "panelTitle.activeBorder": getColor("blue", getTypeShade(10)),
    ...
    "tab.activeBorder": getColor("accent", 12),
