function getWorkbenchCustomizations(
  ...
  return {
    ...
    "breadcrumb.focusForeground": getColor("neutral", getTypeShade(15)),
    ...
    "dropdown.foreground": getColor("neutral", getTypeShade(15)),
    ...
    "editorBracketMatch.border": getColor("blue", getTypeShade(11)),
    ...
    "editorSuggestWidget.foreground": getColor("neutral", getTypeShade(15)),
    ...
    "input.foreground": getColor("neutral", getTypeShade(15)),
    "input.placeholderForeground": "#a6a6a6",
    "inputOption.activeBorder": getColor("accent", getTypeShade(11)),
    "inputValidation.errorBackground": getColor("red", getTypeShade(0)),
    "inputValidation.errorBorder": getColor("red", getTypeShade(4)),
    "inputValidation.infoBackground": getColor("neutral", getTypeShade(0)),
    "inputValidation.infoBorder": getColor("neutral", getTypeShade(4)),
    "inputValidation.warningBackground": getColor("yellow", getTypeShade(0)),
    "inputValidation.warningBorder": getColor("yellow", getTypeShade(4)),
    "list.activeSelectionBackground": getColor("neutral", getTypeShade(2)),
    "list.activeSelectionForeground": getColor("neutral", getTypeShade(15)),
    ...
    "list.highlightForeground": getColor("neutral", getTypeShade(15)),
    ...
    "list.inactiveSelectionForeground": getColor("neutral", getTypeShade(15)),
    ...
    "menu.selectionForeground": getColor("neutral", getTypeShade(15)),
    "menu.separatorBackground": getColor("neutral", getTypeShade(4)),
    "menubar.selectionBackground": getColor("neutral", getTypeShade(2)),
    "menubar.selectionForeground": getColor("neutral", getTypeShade(15)),
    ...
    "panelTitle.activeForeground": getColor("neutral", getTypeShade(15)),
    "panelTitle.inactiveForeground": getColor("neutral", getTypeShade(11)),
    ...
    "tab.activeForeground": getColor("neutral", getTypeShade(15)),
    ...
    "tab.inactiveForeground": getColor("neutral", getTypeShade(11)),
    "tab.inactiveModifiedBorder": getColor("accent", getTypeShade(11), 0.75),
    "tab.unfocusedActiveForeground": getColor("neutral", getTypeShade(15)),
    "tab.unfocusedActiveModifiedBorder": getColor(
      "accent",
      getTypeShade(11),
      0.5
    ),
    "tab.unfocusedInactiveForeground": getColor("neutral", getTypeShade(11)),
    ...
    "titleBar.activeForeground": getColor("neutral", getTypeShade(11)),
